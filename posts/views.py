...
def create_post(request):
    ...
    return render(request, 'create_post.html', {'users': users, 'tags': tags})
...
def create_user_profile(request):
    ...
    users = User.objects.all()  # Get all users for the dropdown
    return render(request, 'create_user_profile.html', {'users': users})
...
def list_user_profiles(request):
    ...
    return render(request, 'list_user_profiles.html', {'user_profiles': user_profiles})
...
def update_post(request, post_id):
    ...
    users = User.objects.all()  # Get all users for the dropdown
    tags = Tag.objects.all()  # Get all tags for the multi-select
    return render(request, 'update_post.html', {'post': post, 'users': users, 'tags': tags})
...
def update_user_profile(request, user_profile_id):
    ...
    # For GET requests, prepare data for the form
    users = User.objects.all()  # Get all users for the dropdown
    return render(request, 'update_user_profile.html', {'user_profile': user_profile, 'users': users})
